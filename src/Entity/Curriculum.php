...
class Curriculum
{
    ...
    #[ORM\ManyToOne(inversedBy: 'curricula'), ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')] private Theme $theme;
    #[ORM\Column(length: 180)] private string $title;
    #[ORM\Column(type: 'integer')] private int $priceCents;
    /** @var Collection<int, Lesson> */
    #[ORM\OneToMany(mappedBy: 'curriculum', targetEntity: Lesson::class, orphanRemoval: true)] private Collection $lessons;
